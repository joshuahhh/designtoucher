...
import { simpleShader, splineInterpolate } from "../common";
 ...
 *              channel (just like for red).
 */
export default function curves(red, green, blue) {
  ...
  window.gl.curves.textures({
    map: 1,
  });
  simpleShader.call(this, window.gl.curves, {});
