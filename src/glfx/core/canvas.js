...
function initialize(width, height) {
  ...
  if (
    window.gl.getExtension("OES_texture_float") &&
    window.gl.getExtension("OES_texture_float_linear")
  ) {
  ...
  this._.extraTexture =
    this._.extraTexture || new Texture(0, 0, window.gl.RGBA, type);
